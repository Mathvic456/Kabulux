...
// To whoever will see his codebase, I am sorry I was vibe coding and I got so 
// tired plus gemini and all other AI tools stressed menubar, I don tire. 
// This is basically the actuall password success screen that will be shown after a 
// user successfully resets their password from the "forgot password" option.
// I hope you find a way to fogive me. Thank you and goodluck
...
export default function PasswordResetSuccessScreen({ next, goRegister, goForgot }: { next: () => void, goRegister: () => void, goForgot: () => void }) {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.bottomSection}>
            ...
            <Text style={styles.title}>Your Password is Successfully Changed</Text>
